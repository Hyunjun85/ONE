...
class ConvPowerVR : public GPUOperation {
 ...
 private:
  ...
  template <DataType T>
  void UploadData(const InternalTensor<OHWI, T>& weights,
                  const InternalTensor<Linear, T>& biases);
  template <DataType T>
  void UploadDataForWinograd4x4To6x6(
      const InternalTensor<OHWI, T>& weights);

  template <DataType T>
  void UploadWeights(const InternalTensor<OHWI, T>& weights);

  template <DataType T>
  void UploadWeights(const InternalTensor<OHWDI, T>& weights);

  template <DataType T>
  void UploadBias(const InternalTensor<Linear, T>& bias);
...
template <DataType T>
void ConvPowerVR::UploadBias(const InternalTensor<Linear, T>& bias) {
...
template <DataType T>
void ConvPowerVR::UploadWeights(const InternalTensor<OHWI, T>& weights) {
...
template <DataType T>
void ConvPowerVR::UploadWeights(const InternalTensor<OHWDI, T>& weights) {
