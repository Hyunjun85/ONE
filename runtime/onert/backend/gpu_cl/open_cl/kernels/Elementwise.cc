...
// GPUOperation CreateElementwiseOneRuntimeOneScalar(const OperationDef &definition,
...
//   }
//   op.code_ = "FLT4 second_val = (FLT4)(args.scalar, args.scalar, args.scalar, "
//              "args.scalar);\n";
//   op.code_ += GetTwoInputCode(op_type, "in_out_value", "in_out_value", "second_val",
//   swap_inputs); return op;
// }

// Creates simple two input(first input is runtime tensor and second input is
// constant linear tensor) operation, for example sub, div and etc.
// GPUOperation CreateElementwiseTwoInput(
//   const DeviceInfo &device_info, const OperationDef &definition, const OperationType &op_type,
//   const InternalTensor<Linear, DataType::FLOAT32> &constant_tensor, bool swap_inputs)
// {
//   const BHWC shape = BHWC(1, 1, 1, constant_tensor.shape.v);
//   TensorStorageType storage_type = SelectBestStorageType(
//     device_info, shape, definition.GetPrimaryStorageType(), definition.GetDataType(),
//     Layout::HWC);
...
//   result.args_.AddObject("second_tensor", absl::make_unique<TensorDescriptor>(std::move(desc)));
//   const std::string s_coord = shape.c == 1 ? "0" : "S_COORD";
//   result.code_ = absl::StrCat("FLT4 second_val = args.second_tensor.Read(0, 0, ", s_coord,
//   ");\n"); if (shape.c == 1)
//   {
...
//   }
//   result.code_ +=
//     GetTwoInputCode(op_type, "in_out_value", "in_out_value", "second_val", swap_inputs);
//   return result;
// }
...
// GPUOperation CreateElementwiseTwoInput(
//   const DeviceInfo &device_info, const OperationDef &definition, const OperationType &op_type,
//   const InternalTensor<HWC, DataType::FLOAT32> &constant_tensor, bool swap_inputs)
// {
//   const BHWC shape =
//     BHWC(1, constant_tensor.shape.h, constant_tensor.shape.w, constant_tensor.shape.c);
//   TensorStorageType storage_type = SelectBestStorageType(
//     device_info, shape, definition.GetPrimaryStorageType(), definition.GetDataType(),
//     Layout::HWC);
//   TensorDescriptor desc{definition.GetDataType(), storage_type, Layout::HWC};
...
//   const std::string s_coord = shape.c == 1 ? "0" : "S_COORD";
//   result.code_ = absl::StrCat("FLT4 second_val = args.second_tensor.Read(", x_coord, ", ",
//   y_coord,
//                               ", ", s_coord, ");\n");
//   if (shape.c == 1)
//   {
...
//   const auto *linear_tensor = absl::get_if<InternalTensor<Linear,
//   DataType::FLOAT32>>(&attr.param); const auto *hwc_tensor = absl::get_if<InternalTensor<HWC,
//   DataType::FLOAT32>>(&attr.param);
...
//   {
//     return CreateElementwiseTwoInput(device_info, definition, op_type, *linear_tensor,
//                                      attr.runtime_tensor_is_second);
//   }
//   else if (hwc_tensor)
//   {
//     return CreateElementwiseTwoInput(device_info, definition, op_type, *hwc_tensor,
//                                      attr.runtime_tensor_is_second);
//   }
//   else
//   {
