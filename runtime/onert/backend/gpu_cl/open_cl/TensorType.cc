...
bool TensorDescriptor::PerformSelector(const std::string &selector,
...
bool TensorDescriptor::PerformReadSelector(const std::vector<std::string> &args,
                                           const std::vector<std::string> &template_args,
                                           std::string *result) const
{
  ...
  if (!template_args.empty())
  {
    ...
    {
      if (!GetDataTypeFromTemplateArgs(template_args[0], &read_as_type))
        return false;
    }
  }
  if (args.size() == 1)
...
bool TensorDescriptor::GetLinkingContextFromWriteSelector(const std::vector<std::string> &args,
                                                          std::string *value_name,
                                                          std::string *x_coord,
                                                          std::string *y_coord,
                                                          std::string *s_coord) const
{
  std::string xc;
  std::string yc;
  std::string zc;
...
bool TensorDescriptor::PerformWriteSelector(const std::vector<std::string> &args,
                                            std::string *result) const
{
  std::string xc;
  std::string yc;
...
bool TensorDescriptor::PerformWriteLinearSelector(const std::vector<std::string> &args,
                                                  std::string *result) const
{
...
bool TensorDescriptor::PerformGetAddressSelector(const std::vector<std::string> &args,
                                                 std::string *result) const
{
  std::string xc;
  std::string yc;
...
// TODO
bool TensorDescriptor::PerformGetPtrWithSliceOffsetSelector(const std::vector<std::string> &args,
                                                            std::string *result) const
{
  if (storage_type != TensorStorageType::BUFFER)
  {
...
bool TensorDescriptor::PerformGetWHOffsetSelector(const std::vector<std::string> &args,
                                                  std::string *result) const
{
  if (storage_type != TensorStorageType::BUFFER && storage_type != TensorStorageType::IMAGE_BUFFER)
  {
...
bool TensorDescriptor::PerformGetHandleSelector(const std::vector<std::string> &args,
                                                std::string *result) const
{
  if (!args.empty())
  {
...
bool TensorDescriptor::GetDataTypeFromTemplateArgs(const std::string &template_arg,
...
// template void DataFromBHWDC<half>(absl::Span<const float> src, const BHWDC &shape,
//                                   const TensorDescriptor &desc, absl::Span<half> dst);
