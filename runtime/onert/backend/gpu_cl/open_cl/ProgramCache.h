...
public:
  ...
  bool GetOrCreateCLKernel(const std::string &code, const std::string &function_name,
  ...
  // bool AddSerializedCache(const CLContext& context,
  //                                 const CLDevice& device,
  //                                 absl::Span<const uint8_t> serialized_cache);
  // bool GetSerializedCache(const CLDevice& device,
