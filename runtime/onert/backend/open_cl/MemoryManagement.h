...
bool BestGreedy(const std::vector<TensorUsageRecord<size_t>> &usage_records,
...
bool AssignObjectsToTensors(const std::vector<TensorUsageRecord<TensorSizeT>> &usage_records,
