...
#ifndef __ONERT_BACKEND_GPU_CL_CL_CONTEXT_H__
#define __ONERT_BACKEND_GPU_CL_CL_CONTEXT_H__
...
bool CreateCLContext(const CLDevice &device, CLContext *result);
bool CreateCLGLContext(const CLDevice &device, cl_context_properties egl_context,
...
#endif // __ONERT_BACKEND_GPU_CL_CL_CONTEXT_H__
