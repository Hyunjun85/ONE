...
#ifndef __ONERT_BACKEND_GPU_CL_TYPES_H__
#define __ONERT_BACKEND_GPU_CL_TYPES_H__
...
public:
  ...
  // TODO
  explicit half(float other) { bits = (uint16_t)other; }
...
#endif // __ONERT_BACKEND_GPU_CL_TYPES_H__
