...
#ifndef __ONERT_BACKEND_GPU_CL_TENSOR_TYPE_H__
#define __ONERT_BACKEND_GPU_CL_TENSOR_TYPE_H__
...
struct TensorDescriptor : public GPUObjectDescriptor
{
  ...
  bool PerformSelector(const std::string &selector, const std::vector<std::string> &args,
  ...
  bool GetLinkingContextFromWriteSelector(const std::vector<std::string> &args,
...
private:
  ...
  bool PerformGetAddressSelector(const std::vector<std::string> &args, std::string *result) const;

  bool PerformGetPtrWithSliceOffsetSelector(const std::vector<std::string> &args,
                                            std::string *result) const;

  bool PerformGetWHOffsetSelector(const std::vector<std::string> &args, std::string *result) const;

  bool PerformGetHandleSelector(const std::vector<std::string> &args, std::string *result) const;
  ...
  bool PerformWriteSelector(const std::vector<std::string> &args, std::string *result) const;

  bool PerformWriteLinearSelector(const std::vector<std::string> &args, std::string *result) const;
  ...
  bool GetDataTypeFromTemplateArgs(const std::string &template_arg, DataType *result) const;
...
#endif // __ONERT_BACKEND_GPU_CL_TENSOR_TYPE_H__
