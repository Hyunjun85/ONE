...
#ifndef __ONERT_BACKEND_GPU_CL_UTIL_H__
#define __ONERT_BACKEND_GPU_CL_UTIL_H__
...
bool CreateCLBuffer(cl_context context, int size_in_bytes, bool read_only, void *data,
                    cl_mem *result);

cl_channel_type DataTypeToChannelType(DataType type, bool normalized = false);
bool CreateRGBAImage2D(cl_context context, int width, int height, cl_channel_type channel_type,
...
#endif // __ONERT_BACKEND_GPU_CL_UTIL_H__
